...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Tuvshinbayar\Documents\PythonProjects\Flask rendering HTML'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Tuvshinbayar\Documents\PythonProjects\Flask rendering HTML\Scripts\deactivate.nu'

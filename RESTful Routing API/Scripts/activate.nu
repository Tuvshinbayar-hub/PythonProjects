...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Tuvshinbayar\Documents\PythonProjects\RESTful Routing API'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Tuvshinbayar\Documents\PythonProjects\RESTful Routing API\Scripts\deactivate.nu'

...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Tuvshinbayar\Documents\PythonProjects\Databases with SQLite and SQLAlchemy'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Tuvshinbayar\Documents\PythonProjects\Databases with SQLite and SQLAlchemy\Scripts\deactivate.nu'
